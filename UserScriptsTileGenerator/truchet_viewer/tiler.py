...
from truchet_viewer.drawing import DEG90, cairo_context
...
class TileBase:
    ...
    def draw_tile(self, ctx, wh: int, bgfg=None, base_color=None, meth_name='draw'):
        g = self.G(wh, bgfg)
...
def show_tiles(
    ...
    with cairo_context(totalW, totalH, format="png", output=output) as ctx:
...
def multiscale_truchet(
    ...
    def one_tile(x, y, size, ilayer, ctx):
